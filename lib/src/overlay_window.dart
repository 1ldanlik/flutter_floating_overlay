...
class FlutterFloatingOverlay {
  FlutterFloatingOverlay._();
  ...
  static const BasicMessageChannel _overlayMessageChannel =
      BasicMessageChannel("overlay_messenger", JSONMessageCodec());
  ...
  static Future<String?> getVideoUrl() async {
    final String? _res = await _channel.invokeMethod('getVideoUrl');
    return _res;
  }
